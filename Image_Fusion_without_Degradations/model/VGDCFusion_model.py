...
class VGDCFusion(nn.Module):
    ...
    def forward(self, inp_img_A, inp_img_B, text_ir, text_vi):
        ...
        out_enc_level4_vi, out_enc_level3_vi, out_enc_level2_vi, out_enc_level1_vi, inp_enc_level1_vi = self.encoder_A(inp_img_A, text_feat_vi)
        out_enc_level4_ir, out_enc_level3_ir, out_enc_level2_ir, out_enc_level1_ir, inp_enc_level1_ir = self.encoder_B(inp_img_B, text_feat_ir)
...
class Encoder_A(nn.Module):
    ...
    def forward(self, inp_img_A, text_vi):
        ...
        return out_enc_level4_A, out_enc_level3_A, out_enc_level2_A, out_enc_level1_A,inp_enc_level1_A
...
class Encoder_B(nn.Module):
    ...
    def forward(self, inp_img_B, text_ir):
        ...
        return out_enc_level4_B, out_enc_level3_B, out_enc_level2_B, out_enc_level1_B,inp_enc_level1_B
