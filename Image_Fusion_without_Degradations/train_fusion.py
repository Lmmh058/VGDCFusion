...
def main(args):
    ...
    print("Loading IVIF Fusion Task!")
    if args.IVIF_train_path is not None:
        train_visible_path_list, train_infrared_path_list = read_data(args.IVIF_train_path)
    else:
        train_visible_path_list, train_infrared_path_list = None, None
    ...
    train_dataset = SimpleDataSet(visible_path=train_visible_path_list,
                                  infrared_path=train_infrared_path_list,
    ...
    for epoch in range(start_epoch, args.epochs):
        train_loss, train_max_loss, train_color_loss, train_text_loss, lr, I_A, I_B, I_fused = train_one_epoch(model=model,
        ...
        labels = ["Input:Visible", "Input:Infrared", "Fused Output"]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--IVIF_train_path', type=str,
                        default="./Train/")
